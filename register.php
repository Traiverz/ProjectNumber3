...
if(isset($_POST['submit']))
{
    ...
    if(count($err) == 0)
    {
        ...
        mysqli_query($link,"INSERT INTO users SET user_login='".$login."', user_password='".$password."', choise='".$design."'");
                ...
                <form class="login100-form validate-form" method="POST">
                    ...
                    <div align="center">
                        <select size="1" name="design">
                            <option disabled selected="selected">Выберите оформление страницы</option>
                          <option value="Forest">Лес</option>
                          <option value="Desert">Пустыня</option>
                          <option value="Volcano">Вулканы</option>
                          <option value="Void">Неизвестность</option>
